...
Login and registration allowed only via college email ID
...
One-tap SOS button available during an active ride

Instantly:

📞 Calls a selected emergency contact (Mother / Father / Friend)

📩 Sends SMS with live location & ride details

Contacts are configurable by the user

🎀 Pink Pool (Women-Only Mode)

Optional Pink Pool toggle

When enabled:

Only women drivers are shown to women riders

Enhances comfort and safety for female students
...
👤 Gender (used for Pink Pool filtering)
...
Multiple plans: Basic, Pro, Elite
...
Enhances student safety, especially for women
